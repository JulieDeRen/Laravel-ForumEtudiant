          ...
          <div class="row justify-content-center">
            <div class="col-lg-6">
              <div class="banner_content text-center">
                ...
                <div class="page_link">
                  <a href="/">Accueil</a>
                  <a href="/employer-index">Employeurs</a>
                  <a href="/employer-show">{{$employer->name}}</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    <div class="main_image">
                        <img class="img-fluid" src="assets/img/courses/course-details.jpg" alt="">
                    </div>
                    <div class="content_wrapper">
                        <h4 class="title">Description de l'entreprise</h4>
                        <div class="content">
                            {{$employer->description}}
                        </div>

                        <h4 class="title">Offres de stages de l'entreprise</h4>
                        <div class="content">
                    ...
                    <ul>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
                                <p>Employeur</p>
                                <span class="or">{{$employer->name}}</span>
                            </a>
                        </li>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
